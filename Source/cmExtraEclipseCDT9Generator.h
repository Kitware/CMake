...
#ifndef cmExtraEclipseCDT9Generator_h
#define cmExtraEclipseCDT9Generator_h
...
/** \class cmExtraEclipseCDT9Generator
 * \brief Write Eclipse project files for Makefile based projects
 */
class cmExtraEclipseCDT9Generator : public cmExternalMakefileProjectGenerator
{
public:
  enum LinkType
  {
