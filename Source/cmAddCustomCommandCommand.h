...
public:
  ...
  virtual const char* GetFullDocumentation() const
    ...
    return
      ...
      "                     [ENVIRONMENT env_expr1 [env_expr2...] ...]\n"
      ...
      "\n"
      "The ENVIRONMENT option specifies a list of key=value pairs "
      "of system environment variable definitions to be supplied "
      "during execution of all COMMAND lines within this custom command."
      "\n"
