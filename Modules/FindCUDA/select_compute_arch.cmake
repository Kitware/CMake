...
function(CUDA_SELECT_NVCC_ARCH_FLAGS out_variable)
  ...
  if("${CUDA_ARCH_NAME}" STREQUAL "Manual")
    ...
    elseif("${CUDA_ARCH_NAME}" STREQUAL "Auto")
      ...
      set(cuda_arch_bin "")
#      string(REGEX REPLACE "\ " ";" CUDA_ARCH_NAME  "${CUDA_ARCH_NAME}")
      list(REMOVE_DUPLICATES CUDA_ARCH_NAME)
      foreach(arch_name ${CUDA_ARCH_NAME})
        if(${arch_name} STREQUAL "Fermi")
          list(ADD cuda_arch_bin "2.0 2.1(2.0)")
        elseif(${arch_name} STREQUAL "Kepler+Tegra")
          list(ADD cuda_arch_bin "3.2 3.2")
        elseif(${arch_name} STREQUAL "Kepler+Tesla")
          list(ADD cuda_arch_bin "3.7 3.7")
        elseif(${arch_name} STREQUAL "Kepler")
          list(ADD cuda_arch_bin "3.0 3.5")
        elseif(${arch_name} STREQUAL "Maxwell+Tegra")
          list(ADD cuda_arch_bin "5.3 5.3")
        elseif(${arch_name} STREQUAL "Maxwell")
          list(ADD cuda_arch_bin "5.0 5.2")
        elseif(${arch_name} STREQUAL "Pascal")
          list(ADD cuda_arch_bin "6.0 6.2")
        else()
