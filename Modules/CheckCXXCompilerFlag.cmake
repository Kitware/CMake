...
function(CHECK_CXX_COMPILER_FLAG_RUN _FLAG _RESULT)
   set(SAFE_CMAKE_REQUIRED_DEFINITIONS "${CMAKE_REQUIRED_DEFINITIONS}")
   set(CMAKE_REQUIRED_DEFINITIONS "${_FLAG}")
   ...
   if(DEFINED ${_RESULT})
      ...
      CHECK_CXX_SOURCE_RUNS("#include<stdio.h>\nint main() { printf(\"%s\", \"${_FLAG}\");return 0; }" ${_RESULT}
        ${_CheckCXXCompilerFlag_COMMON_PATTERNS}
        )
      if(${${_RESULT}})
        message(STATUS "RUN_OUTPUT ${RUN_OUTPUT}")
        if("${RUN_OUTPUT}" STREQUAL "${_FLAG}")
        else()
          unset(${_RESULT} CACHE)
        endif()
      endif()
