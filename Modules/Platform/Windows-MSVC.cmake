...
macro(__windows_compiler_msvc lang)
  ...
  if("x${lang}" STREQUAL "xC" OR
    ...
    if(CMAKE_VS_PLATFORM_TOOLSET MATCHES "v[0-9]+_clang_.*")
      ...
      # Exclude /Ob1 and /Ob2 (inline expansion) for clang with 32-bit output as it breaks variadics as of clang-cl 7.0.1 when clang built-in header path is not included.
