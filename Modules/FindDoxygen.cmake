...
function(doxygen_use_clang_for_target targetName)
    ...
    if(tgtType STREQUAL "INTERFACE_LIBRARY")
        ...
        get_target_property(includez "${targetName}" INCLUDE_DIRECTORIES)
        if(includez)
            list(JOIN includez " -I" includez)
            set(includez "-I${includez}")
        endif()
    endif()

    set(DOXYGEN_CLANG_OPTIONS "${flagz} ${includez}" PARENT_SCOPE)
