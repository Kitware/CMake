...
if (WIN32)
    if (DEFINED ENV{SDL2_ROOT_DIR})
        ...
        if (MINGW)
            ...
            set(SDL2_EXE_LINKER_FLAGS "-mwindows" CACHE STRING "SDL2 additional linker flags.")
        endif ()
    else ()
...
mark_as_advanced(SDL2_INCLUDE_DIR SDL2_LIBRARIES SDL2_EXE_LINKER_FLAGS SDL2_SHARED_LIBRARY_PATH)
