...
set(CMAKE_CXX14_STANDARD_COMPILE_OPTION "--c++=17")
set(CMAKE_CXX14_EXTENSION_COMPILE_OPTION "--c++=17")
...
if(CMAKE_CXX_COMPILER_ARCHITECTURE_ID STREQUAL "TriCore")
  if(CMAKE_TASKING_TOOLSET STREQUAL "SmartCode")
    __compiler_check_default_language_standard(CXX 10.1 10.2 10.3 14 10.4 17)
  else()
...
elseif(CMAKE_CXX_COMPILER_ARCHITECTURE_ID STREQUAL "ARM")
  ...
  elseif(CMAKE_TASKING_TOOLSET STREQUAL "TriCore")
    ...
    __compiler_check_default_language_standard(CXX 6.0 7.1 14)
  endif()
elseif(CMAKE_C_COMPILER_ARCHITECTURE_ID STREQUAL "RISCV")
  __compiler_check_default_language_standard(CXX 1.1 17)
else()
