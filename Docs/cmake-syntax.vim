...
syn case ignore
syn match cmakeComment /#.*$/ contains=cmakeReminder
syn region cmakeRegistry start=/\[/ end=/\]/ skip=/\\[\[\]]/
            \ contained oneline contains=CONTAINED,cmakeReminder
...
syn region cmakeString start=/"/ end=/"/ skip=/\\"/
            \ contains=CONTAINED,cmakeReminder
syn region cmakeArguments start=/\s*(/ end=/)/
           \ contains=ALLBUT,cmakeArguments,cmakeReminder
